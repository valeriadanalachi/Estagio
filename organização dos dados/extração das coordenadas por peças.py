...
path2='C:/Users/valer/OneDrive/Ambiente de Trabalho/estagio/coordenadas'
path3='C:/Users/valer/OneDrive/Ambiente de Trabalho/estagio/coordenadas1'
os.listdir(path)
for moldes in os.listdir(path):
    ...
    for pecas in os.listdir(path+'/'+moldes):
        ...
        ficheiro= open(path3+'/{}.txt'.format(pecas),'w')
